...
"                            let acceptableError = (current_mode == \'brew\' && temp_scale == \'C\') ? 0.5 : 1.0;\n"
...
"                    let target_label = document.getElementById(mode + \"_target_label\");\n"
"                    target_label.innerHTML = target_temp + \" °\" + temp_scale;\n"
"                }\n"
"\n"
...
"                    if(!is_target_loaded) {\n"
"                        [temp_scale, brew_target, steam_target, temp_offset] = [last_output.scale, last_output.targets.brew, last_output.targets.steam, last_output.targets.offset];\n"
...
"                    chart.data.datasets[0].data = temp_data = requested_temp_data;\n"
"                    chart.data.datasets[1].data = target_data.brew = requested_brew_targets;\n"
"                    chart.data.datasets[2].data = output_data.brew = requested_brew_output;\n"
"                    chart.data.datasets[1].data = target_data.steam = requested_steam_targets;\n"
"                    chart.data.datasets[2].data = output_data.steam = requested_steam_output;\n"
"                    \n"
"                    let current_temp = requested_temp_data[requested_temp_data.length - 1].toPrecision(4);\n"
"                    if(current_temp !== undefined) {\n"
"                        if(current_mode == \'brew\') brew_temp_element.innerHTML = current_temp + \" °\" + temp_scale;\n"
"                        else if(current_mode == \'steam\') steam_temp_element.innerHTML = current_temp + \" °\" + temp_scale;\n"
"                    }    \n"
"                    updateElements(current_mode);\n"
"                });\n"
