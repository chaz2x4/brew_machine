...
"                    targetLabel.innerHTML = target_temp + \" \" + degree_mode;\n"
"                }\n"
"\n"
...
"                let maxTemp;\n"
"                if(mode == \"brew\") {\n"
"                    maxTemp = max_brew_temp;\n"
"                    brew_target = (brew_target < maxTemp) ? brew_target + 0.5 : maxTemp; \n"
"                }\n"
"                else if(mode == \"steam\"){\n"
"                    maxTemp = max_steam_temp;\n"
"                    steam_target = (steam_target < maxTemp) ? steam_target + 1 : maxTemp;\n"
"                }\n"
"                else if(mode == \"offset\"){\n"
"                    maxTemp = max_offset;\n"
"                    temp_offset = (temp_offset < maxTemp) ? temp_offset + 0.5 : maxTemp;\n"
"                }\n"
...
"                let minTemp;\n"
"                if(mode == \"brew\") {\n"
"                    minTemp = min_brew_temp;\n"
"                    brew_target = (brew_target > minTemp) ? brew_target - 0.5 : minTemp; \n"
"                }\n"
"                else if(mode == \"steam\"){\n"
"                    minTemp = min_steam_temp;\n"
"                    steam_target = (steam_target > minTemp) ? steam_target - 1 : minTemp;\n"
"                }\n"
"                else if(mode == \"offset\"){\n"
"                    minTemp = min_offset;\n"
"                    temp_offset = (temp_offset > minTemp) ? temp_offset - 0.5 : minTemp;\n"
"                }\n"
...
"                    if(brew_target == null) {\n"
"                        [brew_target, steam_target, temp_offset] = [lastOutput.targets.brew, lastOutput.targets.steam, lastOutput.targets.offset];\n"
"                        updateElements(\'offset\');\n"
"                    }\n"
"                    \n"
"                    sortedOutputs.forEach((output, index) => {             \n"
"                        requestedLabels.push(moment(output.time * 1000 + 1000).fromNow());\n"
...
"                        if(current_temp !== undefined) brew_temp_element.innerHTML = current_temp + \" \" + degree_mode;\n"
"                    }\n"
"                    else { \n"
...
"                        if(current_temp !== undefined) steam_temp_element.innerHTML = current_temp + \" \" + degree_mode;\n"
"                    }        \n"
"\n"
"                    updateElements(current_mode);\n"
"                });\n"
...
"                tuning_button.innerHTML = \'<span class=\"spinner-border spinner-border-sm\" role=\"status\" aria-hidden=\"true\"></span> Tuning...\';\n"
