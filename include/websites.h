...
"                    chart.data.datasets[1].data = outputData.brew;\n"
"                    chart.data.datasets[2].data = targetData.brew;\n"
"                    mode = \'brew\';\n"
"                    updateElements();\n"
"                    chart.render();\n"
"                },\n"
...
"                    chart.data.datasets[1].data = outputData.steam;\n"
"                    chart.data.datasets[2].data = targetData.steam;\n"
"                    mode = \'steam\';\n"
"                    updateElements();\n"
"                    chart.render();\n"
"                }\n"
...
"                    if(mode == \'brew\') { \n"
"                        chart.data.datasets[1].data = outputData.brew = requestedBrewOutput;\n"
"                        chart.data.datasets[2].data = targetData.brew = requestedBrewTargets;\n"
"                    }\n"
"                    else { \n"
"                        chart.data.datasets[1].data = outputData.steam = requestedSteamOutput;\n"
"                        chart.data.datasets[2].data = targetData.steam = requestedSteamTargets;\n"
"                    }        \n"
"\n"
"                    updateElements();\n"
"                    refreshTemps();\n"
