...
"                                    if(context.tick.value == brewData.target[brewData.target.length - 1].y) return \"#FF6384\";\n"
"                                }\n"
...
"                                if(context.tick.value == steamData.target[steamData.target.length - 1].y) return \"#FF6384\";\n"
"                            }\n"
