...
"                callServer.post(\"/increment_target\", mode, function(request){\n"
"                    console.log(request);\n"
"                });\n"
"                console.log(mode);\n"
"                updateElements();\n"
...
"                callServer.post(\"/decrement_target\", mode, function(request){\n"
"                    console.log(request);\n"
"                });\n"
"                console.log(mode);\n"
"                updateElements();\n"
...
"                return callServer.get(\"/get_temps\", function(inherit){\n"
...
"            callServer.get(\"/get_tunings\", function(inherit){\n"
"                var tempData = JSON.parse(inherit.response);\n"
