...
"                    requestedData.outputs.forEach(output => {\n"
"                        labels.push(output.time);\n"
"                        tempData.push(output.temperature);\n"
"                        brewData.push(output.outputs.brew);\n"
"                        steamData.push(output.outputs.steam);\n"
"                    })\n"
